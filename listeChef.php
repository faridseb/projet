...
<div class="container">
<h1 style="color:black;">Listes des Chefs</h1>
        ...
        <tbody>
            <?php foreach($results as $result) { ?>
                <tr>
                <th scope="row"><?=$result['nom_chef']?> <?=$result['prenom_chef']?></th>
                <td><?=$result['email_chef']?></td>
                <td><a href="deleteC.php?id=<?=$result['id_chef']?>">Supprimer</a></td>
                </tr>
            <?php } ?>
            <!-- <tr>
