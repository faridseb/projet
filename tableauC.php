...
include "connect.php" ;
    ...
    $requete1 = "SELECT *  FROM utilisateur JOIN tache ON utilisateur.id_utilisateur=tache.id_utilisateur JOIN projet ON projet.id_projet=tache.id_projet JOIN chef_projet ON chef_projet.id_chef=projet.id_chef WHERE projet.id_projet=$id_pro" ;
    ...
    $requete = "SELECT  utilisateur.nom_utilisateur , utilisateur.prenom_utilisateur , tache.lib_tache ,projet.lib_projet  ,projet.dateD,projet.dateF, chef_projet.nom_chef , chef_projet.prenom_chef , tache.id_tache FROM utilisateur JOIN tache ON utilisateur.id_utilisateur = tache.id_utilisateur JOIN projet ON projet.id_projet=tache.id_projet JOIN chef_projet ON chef_projet.id_chef=projet.id_chef WHERE projet.id_projet=$lib_projet" ;
...
<div class="container">
    <h1 style="color:black;">Listes des taches</h1>
        ...
        <tbody>
            <?php foreach($results as $result) { ?>
                ...
                <td><?=$result['dateD']?></td>
                <td><?=$result['dateF']?></td>
                <!-- <td><a href="deletetache.php?id=<?=$result['id_tache']?>" style="background-color:black; padding:5px 30px;  border-radius: 4px;">Supprimer</a></td> -->
                </tr>
            <?php } ?>
            <!-- <tr>
