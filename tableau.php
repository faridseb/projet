...
include "connect.php" ;
    ...
    $requete = "SELECT  utilisateur.nom_utilisateur , utilisateur.prenom_utilisateur , tache.lib_tache ,projet.lib_projet  ,projet.dateD,projet.dateF, chef_projet.nom_chef , chef_projet.prenom_chef FROM utilisateur JOIN tache ON utilisateur.id_utilisateur = tache.id_utilisateur JOIN projet ON projet.id_projet=tache.id_projet JOIN chef_projet ON chef_projet.id_chef=projet.id_chef WHERE utilisateur.id_utilisateur=$id" ;
